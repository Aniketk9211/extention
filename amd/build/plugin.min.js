...
/**
   ...
   */(Configuration);var _default=async function(){const[tinyMCE,pluginMetadata,setupCommands]=await Promise.all([(0,_loader.getTinyMCE)(),(0,_utils.getPluginMetadata)(_common.component,_common.pluginName),(0,_commands.getSetup)()]);return tinyMCE.PluginManager.add(_common.pluginName,(editor=>(console.log("Setting up commands..."),console.log("setupCommands is:",setupCommands),setupCommands(editor),pluginMetadata))),[_common.pluginName,Configuration]}();return _exports.default=_default,_exports.default}));
